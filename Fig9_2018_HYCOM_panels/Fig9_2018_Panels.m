%% Looking at Chl-a advection of Chl-a in 2018
...
addpath(genpath('/Volumes/PamelaResearch/Luna_project/Fig9_2018_HYCOM_Panels/'))
...
% Get sample ssh to make the mask
yr = 2018;mo=4;dy=1;
...
ssh_mask = (lon_ssh >=-88) & (lon_ssh <= -84) & (lat_ssh <= 26.6); % 2018w
...
dates = datetime(2018,4,1):datetime(2018,4,19);
...
%% Chlorophyll-a spatial panels - Use the same mask from before
...
cb1.Label.String = 'Chlorphyll-a Anomaly (mg/m^3)';
...
%% Save the Figure
savepath = '/Volumes/PamelaResearch/Luna_project/Fig9_2018_HYCOM_Panels/';
figname = [savepath 'Fig9_2018_Panels_HYCOM.tiff'];
